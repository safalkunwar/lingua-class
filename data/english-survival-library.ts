...
xpReward: 30,
  },
  {
    ...
    examples: [
      ...
      { en: "Here is example one.", zh: "这是例子一。", explanation: "Explanation one." },
      { en: "Here is example two.", zh: "这是例子二。", explanation: "Explanation two." },
      { en: "Here is example three.", zh: "这是例子三。", explanation: "Explanation three." },
      { en: "Here is example four.", zh: "这是例子四。", explanation: "Explanation four." },
      { en: "Here is example five.", zh: "这是例子五。", explanation: "Explanation five." },
      { en: "Here is example six.", zh: "这是例子六。", explanation: "Explanation six." },
      { en: "Here is example seven.", zh: "这是例子七。", explanation: "Explanation seven." }
    ],
    commonMistakes: [
      { mistake: "Can you to help me?", correction: "Can you help me?", correctionZh: "情态动词后接动词原形，不加 to。" },
