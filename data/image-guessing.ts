...
,
  ...
  },
  {
    ...
    description: "Common pets and small animals.",
    emoji: "🐾",
    items: [
      {
        id: "pets-1",
        emoji: "🐱",
        answer: "a cat",
        hint: "It purrs and likes to sleep in warm places.",
        category: "pets",
        level: "A1",
        alternatives: ["kitty"],
        image: imageGuessingSvgs["pets-1"],
      },
      {
        id: "pets-2",
        emoji: "🐶",
        answer: "a dog",
        hint: "It wags its tail and loves to fetch sticks.",
        category: "pets",
        level: "A1",
        alternatives: ["puppy"],
        image: imageGuessingSvgs["pets-2"],
      },
      {
        id: "pets-3",
        emoji: "🐰",
        answer: "a rabbit",
        hint: "It has long ears and loves to hop.",
        category: "pets",
        level: "A1",
        alternatives: ["bunny"],
        image: imageGuessingSvgs["pets-3"],
      },
      {
        id: "pets-4",
        emoji: "🐹",
        answer: "a hamster",
        hint: "It is a small furry animal that runs on a wheel.",
        category: "pets",
        level: "A2",
        alternatives: ["rodent"],
        image: imageGuessingSvgs["pets-4"],
      },
      {
        id: "pets-5",
        emoji: "🐦",
        answer: "a bird",
        hint: "It has wings and can sing songs.",
        category: "pets",
        level: "A1",
        alternatives: ["feather"],
        image: imageGuessingSvgs["pets-5"],
      },
      {
        id: "pets-6",
        emoji: "🐸",
        answer: "a frog",
        hint: "It jumps and lives near ponds.",
        category: "pets",
        level: "A1",
        alternatives: ["toad"],
        image: imageGuessingSvgs["pets-6"],
      },
      {
        id: "pets-7",
        emoji: "🐢",
        answer: "a turtle",
        hint: "It carries a hard shell on its back.",
        category: "pets",
        level: "A1",
        alternatives: ["shell"],
        image: imageGuessingSvgs["pets-7"],
      },
      {
        id: "pets-8",
        emoji: "🐍",
        answer: "a snake",
        hint: "It is a long legless reptile.",
        category: "pets",
        level: "A2",
        alternatives: ["reptile"],
        image: imageGuessingSvgs["pets-8"],
      },
      {
        id: "pets-9",
        emoji: "🐼",
        answer: "a panda",
        hint: "It is a black and white bear that eats bamboo.",
        category: "pets",
        level: "A2",
        alternatives: ["bear"],
        image: imageGuessingSvgs["pets-9"],
      },
      {
        id: "pets-10",
        emoji: "🐕",
        answer: "a puppy",
        hint: "It is a young dog that is very playful.",
        category: "pets",
        level: "A1",
        alternatives: ["young dog"],
        image: imageGuessingSvgs["pets-10"],
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        image: imageGuessingSvgs["tr-1"],
      },
      {
        id: "tr-2",
        emoji: "🚌",
        answer: "a bus",
        hint: "It carries many people on the road.",
        category: "transport",
        level: "A1",
        alternatives: ["coach"],
        image: imageGuessingSvgs["tr-2"],
      },
      {
        id: "tr-3",
        emoji: "🚕",
        answer: "a taxi",
        hint: "It is a yellow car you hire for a ride.",
        category: "transport",
        level: "A1",
        alternatives: ["cab"],
        image: imageGuessingSvgs["tr-3"],
      },
      {
        id: "tr-4",
        emoji: "🚲",
        answer: "a bicycle",
        hint: "It has two wheels and you pedal to move.",
        category: "transport",
        level: "A1",
        alternatives: ["bike"],
        image: imageGuessingSvgs["tr-4"],
      },
      {
        id: "tr-5",
        emoji: "🚀",
        answer: "a rocket",
        hint: "It goes very fast and flies to space.",
        category: "transport",
        level: "A2",
        alternatives: ["spaceship"],
        image: imageGuessingSvgs["tr-5"],
      },
      {
        id: "tr-6",
        emoji: "🚂",
        answer: "a train",
        hint: "It rides on rails and carries passengers.",
        category: "transport",
        level: "A1",
        alternatives: ["locomotive"],
        image: imageGuessingSvgs["tr-6"],
      },
      {
        id: "tr-7",
        emoji: "✈️",
        answer: "an airplane",
        hint: "It flies high in the sky with wings.",
        category: "transport",
        level: "A1",
        alternatives: ["plane"],
        image: imageGuessingSvgs["tr-7"],
      },
      {
        id: "tr-8",
        emoji: "🚤",
        answer: "a motorboat",
        hint: "It zooms fast on the water.",
        category: "transport",
        level: "A2",
        alternatives: ["speedboat"],
        image: imageGuessingSvgs["tr-8"],
      },
      {
        id: "tr-9",
        emoji: "🏍️",
        answer: "a motorcycle",
        hint: "It has two wheels and a powerful engine.",
        category: "transport",
        level: "A2",
        alternatives: ["bike"],
        image: imageGuessingSvgs["tr-9"],
      },
      {
        id: "tr-10",
        emoji: "🚁",
        answer: "a helicopter",
        hint: "It flies with spinning blades on top.",
        category: "transport",
        level: "A2",
        alternatives: ["chopper"],
        image: imageGuessingSvgs["tr-10"],
      }
    ]
  }
];
