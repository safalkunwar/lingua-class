  ...
  lessons: [
    {
      ...
      terms: [
        ...
        },
        {
          ...
          english: "Shoot",
          chinese: "哎呀/该死（非常弱）",
          pinyin: "āi yā / gāi sǐ (fēi cháng ruò)",
          pronunciation: "shoot",
          literalMeaning: "To fire a weapon",
          actualMeaning: "Mild expletive, very soft.",
          detailsEn:
            "Extremely mild expletive. Safe for all ages and all settings. Often used by people who avoid stronger language.",
          detailsZh: "极其温和的咒骂。适合所有年龄和所有场合。常被避免使用更强语言的人使用。",
          intensity: 1,
          safetyLabels: [{ label: "Universal", icon: "✅", settings: ["All settings"] }],
          regionalVariations: [
            { region: "American", usage: "Shoot, I forgot my keys.", note: "Very common" },
            { region: "British", usage: "Shoot!", note: "Common" },
            { region: "Australian", usage: "Shoot!", note: "Common" },
          ],
          demographics: { ageGroup: "All ages", tone: "Frustrated", genderNeutral: true },
          nonVerbalCues: { facialExpression: "Slight frown", bodyLanguage: "Hand to forehead" },
          comparative: {
            commonMistakes: ["Using for very strong emotion - may sound dismissive"],
            saferAlternatives: ["Oh no", "Oops", "Darn"],
            similarWords: ["Dang", "Darn", "Heck"],
            culturalNotes: "Considered the most 'proper' mild expletive in American English. Common among parents and teachers.",
          },
        ...
        },
        {
          ...
          english: "Heck",
          chinese: "搞什么/见鬼（非常弱）",
          pinyin: "gǎ shén me / jiàn guǐ (fēi cháng ruò)",
          pronunciation: "hek",
          literalMeaning: "Euphemism for 'hell'",
          actualMeaning: "Mild expletive, family-friendly alternative to 'hell'.",
          detailsEn:
            "Classic family-friendly alternative to 'hell'. Safe for all ages. Very common in American English.",
          detailsZh: "经典的'见鬼'的家庭友好替代品。适合所有年龄。在美式英语中非常常见。",
          intensity: 1,
          safetyLabels: [{ label: "Family Friendly", icon: "✅", settings: ["All settings"] }],
          regionalVariations: [
            { region: "American", usage: "What the heck?", note: "Very common" },
            { region: "British", usage: "What the heck?", note: "Common" },
            { region: "Australian", usage: "What the heck?", note: "Common" },
          ],
          demographics: { ageGroup: "All ages", tone: "Surprised", genderNeutral: true },
          nonVerbalCues: { facialExpression: "Raised eyebrows", bodyLanguage: "Shrug" },
          comparative: {
            commonMistakes: ["Using in very formal settings"],
            saferAlternatives: ["What", "Really?", "Oh no"],
            similarWords: ["Hell", "Dang", "Darn"],
            culturalNotes: "Originated as a euphemism for 'hell' but has become a standalone mild expletive. Common among children and adults.",
          },
