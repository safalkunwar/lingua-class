...
export default function RoughEnglishReadModePage() {
      ...
      <div className="flex-1 p-4 sm:p-6 lg:p-8">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            <Link href="/rough-english">
              <Button variant="ghost">
                <ChevronLeft className="w-4 h-4 mr-1" />
                Back to Rough English
              </Button>
            </Link>
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl sm:text-4xl font-bold mb-2">⚠️ Rough English</h1>
          ...
          <div className="p-4 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 rounded-xl mb-8">
