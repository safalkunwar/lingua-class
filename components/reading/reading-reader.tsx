  ...
  return (
    <div className={`mx-auto w-full max-w-5xl ${focusMode ? "fixed inset-0 z-50 bg-background overflow-y-auto" : ""}`}>
      ...
      <div className="p-4 sm:p-6 lg:p-8 space-y-8">
        ...
        <Card className="p-6 sm:p-8">
          <SectionTitle icon={BookOpen}>Before You Read</SectionTitle>
        ...
        <Card className="p-6 sm:p-8">
          <SectionTitle icon={Sparkles}>Vocabulary</SectionTitle>
        ...
        <Card className="p-6 sm:p-8">
          <SectionTitle icon={MessageSquare}>Questions</SectionTitle>
          <p className="text-sm text-muted-foreground mb-4">Answer the questions, then reveal explanations to check your understanding.</p>
          <div className="space-y-6">
        ...
        <Card className="p-6 sm:p-8">
          <SectionTitle icon={PenTool}>Grammar from the Passage</SectionTitle>
        ...
        <Card className="p-6 sm:p-8">
          <SectionTitle icon={MessageCircle}>Collocations</SectionTitle>
          <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Card className="p-6 sm:p-8">
          <SectionTitle icon={Target}>Reading Strategies & Tips</SectionTitle>
          <div className="space-y-4">
        ...
        <Card className="p-6 sm:p-8">
          <SectionTitle icon={Brain}>Think About It</SectionTitle>
        ...
        <Card className="p-6 sm:p-8">
          <SectionTitle icon={Volume2}>Speaking</SectionTitle>
          <h3 className="text-lg font-bold mb-2">{passage.speakingPrompt.title}</h3>
        ...
        <Card className="p-6 sm:p-8">
          <SectionTitle icon={PenTool}>Writing</SectionTitle>
          <h3 className="text-lg font-bold mb-2">{passage.writingPrompt.title}</h3>
        ...
        {teacherMode && (
          <Card className="p-6 sm:p-8">
            <SectionTitle icon={GraduationCap}>Teacher Guide</SectionTitle>
